...
Route::group(['middleware' => ['web', 'phone_scheduler_role_check']], function () {
    Route::group(['namespace' => 'Xguard\PhoneScheduler\Http\Controllers',], function () {
        Route::group(['prefix' => 'phone-scheduler',], function () {
            ...
            Route::get('/get-opening-hours/{id}', 'PhoneScheduleController@getOpeningHours');
...
Route::group(['namespace' => 'Xguard\PhoneScheduler\Http\Controllers',], function () {
    Route::group(['prefix' => 'phone-scheduler',], function () {
        ...
        Route::get('/api/get-recent-caller-info/{id}/{phone}', 'PhoneScheduleController@getRecentCallerInfo');
        ...
        Route::get('/api/get-opening-hours/{id}', 'PhoneScheduleController@getOpeningHours');
    });
});
