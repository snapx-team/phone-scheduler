...
use Xguard\PhoneScheduler\Models\Log;
...
class EmployeeController extends Controller
{
    ...
    {
        $rules = [
            'name' => 'required|unique:ps_employees,name,' . $request->input('id') . ',id',
            'phone' => 'required|unique:ps_employees,phone,' . $request->input('id') . ',id|digits_between:9,11',
            'email' => 'required|unique:ps_employees,email,' . $request->input('id') . ',id',
            'role' => 'required',
            'is_active' => 'required',
        ];
